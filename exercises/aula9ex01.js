...
let cylinder = new THREE.Mesh( cylinderGeometry, woodTextures );
cylinder.castShadow = true;
cylinder.position.set(0.0, 1.5, 1.0);
scene.add( cylinder );
...
function setMaterial(file, repeatU = 1, repeatV = 1, color = 'rgb(255,255,255)'){
   let mat = new THREE.MeshBasicMaterial({ map: textureLoader.load(file), color:color});
