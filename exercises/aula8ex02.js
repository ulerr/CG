...
function generatePoints(numberOfPoints)
{
  ...
  points.push(new THREE.Vector3(5,0,5));
	...
	points.push(new THREE.Vector3(15,0,10));
	points.push(new THREE.Vector3(5,3,5));
	points.push(new THREE.Vector3(10,3,5));
	points.push(new THREE.Vector3(5,3,10));
	points.push(new THREE.Vector3(10,3,10));
